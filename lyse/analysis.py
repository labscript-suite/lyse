...
class AnalysisRoutine(object):
    ...
    def __init__(self, app, filepath, model, output_box_port, checked=QtCore.Qt.Checked):
        ...
        self.COL_ACTIVE = lyse.widgets.RoutineBox.COL_ACTIVE
        self.COL_STATUS = lyse.widgets.RoutineBox.COL_STATUS
        self.COL_NAME = lyse.widgets.RoutineBox.COL_NAME
        self.ROLE_FULLPATH = lyse.widgets.RoutineBox.ROLE_FULLPATH
